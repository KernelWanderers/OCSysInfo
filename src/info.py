...
version_dict = {
    ...
    12: f"Mac OS X 10.8 {color_text('(Mountain Lion)', 'cyan')}",
    13: f"Mac OS X 10.9 {color_text('(Mavericks)', 'cyan')}",
    14: f"Mac OS X 10.10 {color_text('(Yosemite)', 'cyan')}",
    15: f"Mac OS X 10.11 {color_text('(El Capitan)', 'cyan')}",
    16: f"Mac OS X 10.12 {color_text('(Sierra)', 'cyan')}",
    17: f"Mac OS X 10.13 {color_text('(High Sierra)', 'cyan')}",
    18: f"Mac OS X 10.14 {color_text('(Mojave)', 'cyan')}",
    19: f"Mac OS X 10.15 {color_text('(Catalina)', 'cyan')}",
